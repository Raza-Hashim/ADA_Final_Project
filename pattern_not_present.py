...
def time_naive_string_matcher(texts, patterns, num_trials=5):
    times = []
...
def time_kmp_matcher(texts, patterns, num_trials=5):
    times = []
    for text, pattern in zip(texts, patterns):
        avg_time = 0
        for _ in range(num_trials):
...
def time_rk_string_matcher(texts, patterns, num_trials=5):
    times = []
    for text, pattern in zip(texts, patterns):
        avg_time = 0
        for _ in range(num_trials):
...
def time_bm_matcher(texts, patterns, num_trials=5):
    times = []
    for text, pattern in zip(texts, patterns):
        avg_time = 0
        for _ in range(num_trials):
...
plt.title('Time Taken by String Matching Algorithms')
